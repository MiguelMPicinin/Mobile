//classe responsavel por buscar as informações no TMDB e converter em OBJ
...
class TmdbController {
  ...
  // static significa que é um atributo da classe e não do objeto

  //método para buscar filme com base no texto
  //static -> método executado pela classe e não pelo Objteo
  static Future<List<Map<String,dynamic>>> searchMovies(String query) async{
    ...
    if(response.statusCode == 200){
      ...
      //retorna string em List<Map<String, dynamic>>
