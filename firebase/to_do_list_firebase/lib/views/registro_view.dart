...
class _RegistroViewState extends State<RegistroView> {
  ...
  void _registrar() async {
    if (_senhaField.text != _confSenhaField.text)
      return; //interrompe o método se senhas diferentes
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Ocorreu um erro ao registrar $e")),
      );
    }
  }
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            decoration: InputDecoration(labelText: "Confirmar Senha", suffix: IconButton(
              onPressed: ()=> setState(() {
                _confSenhaOculta = !_confSenhaOculta;
              }), 
                  icon: _confSenhaOculta ? Icon(Icons.visibility) : Icon(Icons.visibility_off))),
